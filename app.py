...
# DÉFINIR VOTRE PROPRE ORDRE des images et les regrouper par propositions
# Modifiez cette liste selon VOTRE ordre souhaité
tse_images_ordered = [
    # Proposition 1 - Modifiez les numéros selon votre ordre
    ("TSE/SportsWear Design/1.png", "Proposition 1"),
    ("TSE/SportsWear Design/2.png", "Proposition 1"),
    ("TSE/SportsWear Design/3.png", "Proposition 1"),
    ("TSE/SportsWear Design/4.png", "Proposition 1"),
    ("TSE/SportsWear Design/5.png", "Proposition 1"),
    
    # Proposition 2 - Modifiez les numéros selon votre ordre
    ("TSE/SportsWear Design/6.png", "Proposition 2"),
    ("TSE/SportsWear Design/7.png", "Proposition 2"),
    ("TSE/SportsWear Design/8.png", "Proposition 2"),
    ("TSE/SportsWear Design/9.png", "Proposition 2"),
    ("TSE/SportsWear Design/10.png", "Proposition 2"),
    ("TSE/SportsWear Design/11.png", "Proposition 2"),
    ("TSE/SportsWear Design/12.png", "Proposition 2")
]

# Variable pour suivre la proposition actuelle
current_proposition = None

# Afficher les images dans VOTRE ordre
for idx, (img_path, proposition) in enumerate(tse_images_ordered):
    img_number = idx + 1  # Numéro d'affichage (1, 2, 3...)
    
    # Afficher un titre quand on change de proposition
    ...
    try:
        ...
        # Récupérer le numéro réel du fichier (ex: "1" de "1.png")
