...
# Réorganiser les images dans l'ordre spécifique
# Proposition 1: images 1, 2, 3, 4, 5
# Proposition 2: images 6, 7, 8, 9, 10, 11, 12

tse_images_reordered = [
...
# Variables pour suivre les titres
current_proposition = None

# Afficher chaque image avec regroupement par proposition
for idx, (img_path, proposition) in enumerate(tse_images_reordered):
    img_number = idx + 1
    
    # Afficher un titre de section quand la proposition change
